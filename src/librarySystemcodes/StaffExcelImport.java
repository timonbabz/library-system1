...
public class StaffExcelImport extends JFrame {
 ...
 public StaffExcelImport() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException, IOException {
...
{
    String idNo = (String)table.getValueAt(row, 0);
    String staffFname = (String)table.getValueAt(row, 1);
    String staffLname = (String)table.getValueAt(row, 2);
    String dept = (String)table.getValueAt(row, 3);
    String phoneNo = (String)table.getValueAt(row, 4);
...
table.setModel(new DefaultTableModel());
 ...
 public static void main(String[] args) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException, IOException {
    ...
    StaffExcelImport frame = new StaffExcelImport();
    frame.setTitle("ADD STAFF FROM EXCEL SHEET");
